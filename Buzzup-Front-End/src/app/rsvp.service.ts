...
export class RsvpService {
  data: any;
  private _url = "http://127.0.0.1:9075/api/v1/event";
  movies_url = "http://127.0.0.1:9075/api/v1/event/get/?emailId=";
  email_url = "http://127.0.0.1:9076/api/v1/email/sendEmail";
